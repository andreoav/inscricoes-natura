<div class="row">
	<div class="span12">
		...
		<form action="<?php echo Uri::create('usuario/perfil'); ?>" class="form form-horizontal form-dovalidation" method="POST">
			<fieldset>
	          	<div class="control-group">
	          		<?php echo Form::label('Nome Completo', 'usuario_nome', array('class' => 'control-label')); ?>
	            	<div class="controls">
	            		<?php echo Form::input('usuario_nome', $usuario_dados['nome'], array('id' => 'usuario_nome', 'class' => 'input-xlarge', 'data-validation-engine' => 'validate[required]')); ?>
	            	</div>
	          	</div>
	          	<div class="control-group">
	          		<?php echo Form::label('CPF', 'usuario_cpf', array('class' => 'control-label')); ?>
	            	<div class="controls">
	            		<?php echo Form::input('usuario_cpf', $usuario_dados['cpf'], array('id' => 'usuario_cpf', 'class' => 'input-xlarge', 'data-validation-engine' => 'validate[required, custom[valid_cpf]]')); ?>
	              		<p class="help-block">Formato: xxx.xxx.xxx-xx</p>
	            	</div>
	          	</div>
	          	<div class="control-group">
	          		<?php echo Form::label('Identidade', 'usuario_identidade', array('class' => 'control-label')); ?>
	            	<div class="controls">
	            		<?php echo Form::input('usuario_identidade', $usuario_dados['identidade'], array('id' => 'usuario_identidade', 'class' => 'input-xlarge', 'data-validation-engine' => 'validate[required]')); ?>
	              		<p class="help-block">Formato: xxxxxxxxxx</p>
	            	</div>
	          	</div>
	          	<div class="control-group">
	          		<?php echo Form::label('Data de Nascimento', 'usuario_nascimento', array('class' => 'control-label')); ?>
	            	<div class="controls">
	            		<?php echo Form::input('usuario_nascimento', $usuario_dados['nascimento'], array('id' => 'usuario_nascimento', 'class' => 'input-xlarge dataBR', 'data-validation-engine' => 'validate[required, custom[dateBR]]')); ?>
	              		<p class="help-block">Formato: xx/xx/xxxx</p>
	            	</div>
	          	</div>
	          	<div class="control-group">
